    ...
    <>
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '64px 48px 40px', background: 'rgba(255,255,255,0.01)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          {/* Contact bar */}
          <div style={{ display: 'flex', justifyContent: 'center', gap: 32, marginBottom: 24, padding: '16px 0', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
