      ...
      <div style={{
        ...
        {showUssd && (
          <div style={{
            ...
            {!responded && (
              <>
                <div style={{ fontSize: 10, color: '#F0F6FF', fontWeight: 700, marginTop: 4 }}>
                  🛡️ PayGuard Security Alert
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 8, color: '#64748B' }}>Awaiting response…</div>
                </div>
              </>
            )}
            ...
            {responded && !denied && (
              <div style={{
                ...
                <div style={{ fontSize: 9, color: '#94A3B8', textAlign: 'center', lineHeight: 1.5 }}>
    ...
    <div style={{ padding: '32px 40px', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: 32 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
          ...
          <div>
            <h1 style={{ fontSize: 24, fontWeight: 800, color: '#F0F6FF', margin: 0 }}>
        ...
        <div style={{
          ...
          background: '#0F172A', borderRadius: 8, borderLeft: '3px solid #0EA5E9',
      ...
      <div style={{ display: 'flex', gap: 32, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 12, fontWeight: 700, color: '#64748B', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 18 }}>
              Authorization Flow
            </div>
                    ...
                    <div style={{ paddingTop: 4, paddingBottom: 14 }}>
                      ...
                      {isActive && (
                        <div style={{
                          ...
                          {i === 4 && (scenario.outcome === 'confirmed' ? '🛡️ Device promoted to trusted' : '🚫 Device blocked')}
                        </div>
                      )}
                    </div>
                  </div>
